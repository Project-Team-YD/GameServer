...
func (c *globalGRpcServiceClient) GlobalGRpc(ctx context.Context, in *GlobalGrpcRequest, opts ...grpc.CallOption) (*GlobalGrpcResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/main_grpc.GlobalGRpcService/GlobalGRpc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *globalGRpcServiceClient) GlobalGrpcStream(ctx context.Context, opts ...grpc.CallOption) (GlobalGRpcService_GlobalGrpcStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GlobalGRpcService_ServiceDesc.Streams[0], "/main_grpc.GlobalGRpcService/GlobalGrpcStream", opts...)
	if err != nil {
		return nil, err
	}
...
type GlobalGRpcService_GlobalGrpcStreamClient interface {
	...
	CloseAndRecv() (*GlobalGrpcResponse, error)
	grpc.ClientStream
}
...
func (x *globalGRpcServiceGlobalGrpcStreamClient) CloseAndRecv() (*GlobalGrpcResponse, error) {
...
func _GlobalGRpcService_GlobalGRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main_grpc.GlobalGRpcService/GlobalGRpc",
	}
...
type GlobalGRpcService_GlobalGrpcStreamServer interface {
	SendAndClose(*GlobalGrpcResponse) error
...
func (x *globalGRpcServiceGlobalGrpcStreamServer) SendAndClose(m *GlobalGrpcResponse) error {
